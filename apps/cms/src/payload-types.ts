...
export interface GallerySection {
  ...
  /**
   * URL identifier, e.g. "wheel", "door-panel", "salon"
   */
  slug: string;
  /**
   * Order on the gallery landing page
   */
  order?: number | null;
  images?:
    | {
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "service-cards".
 */
export interface ServiceCard {
  ...
  cards?:
    | {
        title: string;
        /**
         * Used for gallery link: /gallery/{slug}
         */
        slug: string;
        media: number | Media;
        id?: string | null;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "service-cards_select".
 */
export interface ServiceCardsSelect<T extends boolean = true> {
  cards?:
    | T
    | {
        title?: T;
